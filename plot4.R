...
plot(plotdata$DateTime, as.numeric(as.character(plotdata$Global_active_power)),type='l',ylab="Global Active Power", xlab="" ,axes = F,frame.plot=TRUE)
...
plot(plotdata$DateTime, as.numeric(as.character(plotdata$Sub_metering_1)),type='l', xlab="",ylab ="Energy sub metering" ,axes = F,frame.plot=TRUE)
...
plot(plotdata$DateTime, as.numeric(as.character(plotdata$Voltage)),type='l', 
     ylab="Voltage",xlab="datetime",axes = F,frame.plot=TRUE)
     axis(1, at=c(as.numeric(min(plotdata$DateTime)), as.numeric(min(plotdata$DateTime))+86400
             , as.numeric(min(plotdata$DateTime))+2*86400), labels=c("Thu", "Fri", "Sat"))
     axis(2, yaxs = "r")

plot(plotdata$DateTime, as.numeric(as.character(plotdata$Global_reactive_power)),type='l', 
     ylab="Global_reactive_power",xlab="datetime",axes = F,frame.plot=TRUE )
     axis(1, at=c(as.numeric(min(plotdata$DateTime)), as.numeric(min(plotdata$DateTime))+86400
             , as.numeric(min(plotdata$DateTime))+2*86400), labels=c("Thu", "Fri", "Sat"))
     axis(2, yaxs = "r")
